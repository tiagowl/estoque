...
>(({ defaultOpen = true, open: openProp, onOpenChange: setOpenProp, className, style, children, ...props }, ref) => {
  ...
  const contextValue = React.useMemo<SidebarContext>(
    () => ({
      ...
      openMobile,
      setOpenMobile,
      toggleSidebar: () => handleSetOpen((open) => !open),
    }),
    [state, open, handleSetOpen, isMobile, openMobile]
  )
    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn(
            "group/sidebar-wrapper flex min-h-svh w-full has-data-[collapsible=icon]:lg:has-data-[variant=sidebar]:lg:w-[calc(var(--sidebar-width-icon)_+_theme(spacing.4))]",
            className
          )}
          ref={ref}
          {...props}
...
>(({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...props }, ref) => {
  ...
  return (
    <aside
      ref={ref}
      className={cn(
        "group peer hidden text-sidebar-foreground transition-[width] duration-200 ease-linear lg:block text-sidebar-foreground",
        "group-data-[collapsible=icon]/sidebar-wrapper:lg:w-[--sidebar-width-icon]",
    ...
    >
      <div
        ...
        data-side={side}
        className={cn(
          "flex h-full w-full flex-col bg-sidebar group-data-[collapsible=icon]/sidebar-wrapper:lg:bg-sidebar",
          "group-data-[side=right]/sidebar-wrapper:border-l",
          "group-data-[side=left]/sidebar-wrapper:border-r"
        )}
      >
        {children}
      </div>
    ...
    return (
      <button
        ...
        className={cn(
          ...
          "[[data-side=left][data-collapsible=offcanvas]_&]:-right-4 [[data-side=right][data-collapsible=offcanvas]_&]:-left-4",
          className
        )}
        {...props}
      />
